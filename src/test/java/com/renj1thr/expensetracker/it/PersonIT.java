...
public class PersonIT {
	...
	public void addPerson() throws Exception {
		...
		String request_body = "{\"id\":3,\"firstName\":\"Sreelekha\",\"lastName\":\"Ramesh\",\"accounts\":[]}";
		
		String expected_response = "{\"id\":3,\"firstName\":\"Sreelekha\",\"lastName\":\"Ramesh\",\"accounts\":[]}";
		
		this.mockMvc.
			perform(
					post("/addPerson").contentType("application/json").content(request_body))
			.andExpect(status().isOk())
			.andExpect(content().contentType(MediaType.APPLICATION_JSON))
